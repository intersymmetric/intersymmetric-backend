export const template = {
  ...
  buf1: { min: 0, max: 19, value: 0 },
  buf2: { min: 0, max: 19, value: 12 },
  buf3: { min: 0, max: 19, value: 8 },
  buf4: { min: 0, max: 19, value: 12 },
  buf5: { min: 0, max: 19, value: 13 },
  buf6: { min: 20, max: 33, value: 31 },
  ...
  div1: { min: 1, max: 16, value: 1 },
  div2: { min: 1, max: 16, value: 3 },
  div3: { min: 1, max: 16, value: 16 },

  range0: { min: 1, max: 16, value: 8 },
  range1: { min: 1, max: 16, value: 12 },
  range2: { min: 1, max: 16, value: 7 },
  range3: { min: 1, max: 16, value: 16 },
