...
if (env == 'live') {
    const privateKey = fs.readFileSync(certStorage + certApplication + 'ctrl.intersymmetric.xyz.key', 'utf8');
    const certificate = fs.readFileSync(certStorage + certApplication + 'ctrl.intersymmetric.xyz.crt', 'utf8');
